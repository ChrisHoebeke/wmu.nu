...
#         # immediately start loading up a new version of itself (loaded with a
#         new
#           # version of our app). When this new Unicorn is completely loaded
#             # it will begin spawning workers. The first worker spawned will
#             check to
#               # see if an .oldbin pidfile exists. If so, this means we've
#               just booted up
#                 # a new Unicorn and need to tell the old one that it can now
#                 die. To do so
#                   # we send it a QUIT.
#                     #
